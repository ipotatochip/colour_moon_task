$(document).ready(function(){
  ...
  $(document).ready(function(){
    ...
    $(this).attr('src','./images/rest_images/after_1.png');
    },function(){
    $(this).attr('src','./images/rest_images/before_1.png');
    });
    });

    $(document).ready(function(){
      $('.img-hvr-2').hover(function(){
      $(this).attr('src','./images/rest_images/after_2.png');
      },function(){
      $(this).attr('src','./images/rest_images/before_2.png');
      });
      });
